...
class CapaMixin(ScorableXBlockMixin, CapaFields):
    ...
    def submit_problem(self, data, override_time=False):
        ...
        if self.closed():
            self.log_closed_problem_info_for_harvard_course(text_type(self.location))
    ...
    def log_closed_problem_info_for_harvard_course(self, problem_location):
        """Temporary log to get more information"""
